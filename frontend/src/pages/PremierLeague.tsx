...
const mockMatches = [
  {
    ...
    homeTeam: 'Arsenal',
    awayTeam: 'Liverpool',
    startTime: new Date('2024-03-05T20:50:00').getTime(),
  ...
  },
  {
    ...
    awayTeam: 'Chelsea',
    startTime: new Date('2024-03-05T22:00:00').getTime(),
    odds: { home: 2.40, draw: 3.40, away: 2.70 },
    comments: []
  },
  {
    id: 3,
  ...
  },
  {
    ...
    startTime: new Date('2024-03-07T19:30:00').getTime(),
  ...
  },
  {
    ...
    homeTeam: 'Brentford',
    awayTeam: 'West Ham',
    startTime: new Date('2024-03-07T20:15:00').getTime(),
...
function PremierLeague() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-white mb-8">Premier League</h1>
