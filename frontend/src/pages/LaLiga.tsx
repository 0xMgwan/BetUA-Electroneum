...
const mockMatches = [
  {
    ...
    startTime: new Date('2024-03-05T19:00:00').getTime(),
  ...
  },
  {
    ...
    awayTeam: 'Sevilla',
    startTime: new Date('2024-03-05T21:00:00').getTime(),
  ...
  },
  {
    ...
    homeTeam: 'Real Betis',
    awayTeam: 'Valencia',
    startTime: new Date('2024-03-06T19:00:00').getTime(),
  ...
  },
  {
    ...
    homeTeam: 'Villarreal',
    awayTeam: 'Getafe',
    startTime: new Date('2024-03-07T19:00:00').getTime(),
  ...
  },
  {
    ...
    homeTeam: 'Osasuna',
    awayTeam: 'Mallorca',
    startTime: new Date('2024-03-07T21:00:00').getTime(),
...
function LaLiga() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-white mb-8">La Liga</h1>
