...
const mockMatches = [
  {
    ...
    startTime: new Date('2024-03-05T20:00:00').getTime(),
  ...
  },
  {
    ...
    homeTeam: 'Arsenal',
    awayTeam: 'Liverpool',
    startTime: new Date('2024-03-05T20:45:00').getTime(),
  ...
  },
  {
    ...
    startTime: new Date('2024-03-06T21:00:00').getTime(),
  ...
  },
  {
    ...
    awayTeam: 'AC Milan',
    startTime: new Date('2024-03-06T21:45:00').getTime(),
  ...
  },
  {
    ...
    startTime: new Date('2024-03-07T20:30:00').getTime(),
  ...
  },
  {
    ...
    startTime: new Date('2024-03-07T22:00:00').getTime(),
      ...
      <div className="flex flex-wrap gap-4 mb-8">
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium transition-colors ${
            selectedLeague === 'all' ? 'bg-indigo-600 text-white' : 'bg-navy-800 text-gray-300 hover:bg-navy-700'
          }`}
        >
          All Leagues
        </button>
        <button
          onClick={() => setSelectedLeague('UEFA Champions League')}
          className={`px-6 py-2 rounded-lg font-medium transition-colors ${
            selectedLeague === 'UEFA Champions League' ? 'bg-indigo-600 text-white' : 'bg-navy-800 text-gray-300 hover:bg-navy-700'
          }`}
        >
          Champions League
        </button>
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium transition-colors ${
            selectedLeague === 'Premier League' ? 'bg-indigo-600 text-white' : 'bg-navy-800 text-gray-300 hover:bg-navy-700'
          }`}
        >
          Premier League
        </button>
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium transition-colors ${
            selectedLeague === 'La Liga' ? 'bg-indigo-600 text-white' : 'bg-navy-800 text-gray-300 hover:bg-navy-700'
          }`}
        >
          La Liga
        </button>
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium transition-colors ${
            selectedLeague === 'Serie A' ? 'bg-indigo-600 text-white' : 'bg-navy-800 text-gray-300 hover:bg-navy-700'
          }`}
        >
          Serie A
        </button>
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium transition-colors ${
            selectedLeague === 'Bundesliga' ? 'bg-indigo-600 text-white' : 'bg-navy-800 text-gray-300 hover:bg-navy-700'
          }`}
        >
          Bundesliga
        </button>
        ...
        {filteredMatches.map((match) => (
          <div key={match.id} className="bg-navy-800 rounded-lg p-6">
            ...
            <div className="flex flex-col mb-6">
              <div className="text-indigo-400 font-medium mb-2">{match.league}</div>
              {match.round && (
                <div className="text-gray-400 text-sm mb-2">{match.round}</div>
              )}
