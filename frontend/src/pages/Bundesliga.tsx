...
const mockMatches = [
  {
    ...
    startTime: new Date('2024-03-05T20:30:00').getTime(),
  ...
  },
  {
    ...
    startTime: new Date('2024-03-05T18:30:00').getTime(),
  ...
  },
  {
    ...
    awayTeam: 'Stuttgart',
    startTime: new Date('2024-03-06T20:30:00').getTime(),
...
function Bundesliga() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-white mb-8">Bundesliga</h1>
